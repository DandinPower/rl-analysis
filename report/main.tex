...
\begin{table}[t]
  ...
  \small
  \input{helper/tables/task_selection_overview.tex}
\end{table}
...
\begin{table}[!htbp]
  ...
  \scriptsize
  \input{helper/tables/model_training_settings.tex}
\end{table}
...
\begin{table}[t]
  ...
  \scriptsize
  \input{helper/tables/lunar_lander_variant_summary.tex}
\end{table}
...
\begin{table}[!htbp]
  ...
  \scriptsize
  \input{helper/tables/freeway_variant_summary.tex}
\end{table}
...
\begin{table}[htbp]
  ...
  \scriptsize
  \input{helper/tables/aggregate_variant_comparison.tex}
\end{table}
